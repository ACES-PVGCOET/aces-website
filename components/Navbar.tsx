  ...
  return (
    <header className="relative z-50 max-w-7xl mx-auto px-6 sm:px-10 h-24 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        <button className="px-6 py-2.5 rounded-full border border-purple-500/50 bg-purple-950/20 hover:bg-purple-900/40 text-purple-200 hover:text-white font-medium text-sm transition-all duration-300 flex items-center gap-2 shadow-[0_0_15px_rgba(168,85,247,0.2)] hover:shadow-[0_0_25px_rgba(168,85,247,0.5)]">
          Join Us <ArrowUpRight className="w-4 h-4 text-purple-400" />
        </button>
